...
class _ChannelListViewState extends State<ChannelListView> {
              ...
              childrenDelegate: SliverChildBuilderDelegate(
                ...
                findChildIndexCallback: (key) {
                  ...
                  final index = channels.indexWhere(
                          (channel) =>
                      'CHANNEL-${channel.id}' == valueKey.value);
  ...
  Widget _itemBuilder(context, int i, List<Channel> channels) {
    print("Channels from list $channels ");
    ...
    final streamChat = StreamChat.of(context);
    print("Channels: ${streamChat.client.channels}");
    print("This is i: $i");
    ...
    if (i < channels.length) {
      ...
      String id = "${channel.type}${channel.id}";
      print("The main id stuff :$id");

      final channelClient = streamChat.client.channels["${channel
          .type}:${channel.id}"];
